  ...
  try {
    if (Object.keys(req.body).length == 0) {
      return res
        ...
        .send({
          status: false,
          message: "Please Provide Necessary Details to create product",
        });
    }
    let {
      title,
    ...
    if (!validator.isValid(title)) {
      return res
        ...
        .send({
          status: false,
          message: "please enter title, this field is mandatory",
        });
    }
    ...
    if (findTitle) {
      return res
        .status(409)
        .send({ status: false, message: "product title already present" });
    }
    if (!validator.isValid(description)) {
      return res
        ...
        .send({
          status: false,
          message: "please enter description, this field is mandatory",
        });
    }
    if (!validator.isValid(price) || !validator.isValidDecimalNumber(price)) {
      return res
        ...
        .send({
          status: false,
          message: "please enter valid price, this field is mandatory",
        });
    }
    if (!validator.isValid(currencyId) || currencyId.toUpperCase() != "INR") {
      return res
        ...
        .send({
          status: false,
          message:
            "please enter valid currencyId, this field is mandatory, e.g: INR",
        });
    }
    if (!validator.isValid(currencyFormat) || currencyFormat != "₹") {
      return res
        ...
        .send({
          status: false,
          message:
            "please enter valid currencyFormat, this field is mandatory, e.g: ₹",
        });
    }
    if (
      !validator.isValid(availableSizes) ||
      !validator.isValidSize(availableSizes)
    ) {
      return res
        .status(400)
        .send({
          status: false,
          message:
            "please enter valid availableSizes, at least on Size, e.g: M",
        });
    }
    ...
    if (isFreeShipping == "") {
      return res
        ...
        .send({
          status: false,
          message:
            "you selected the isFreeShipping field but value not provided",
        });
    }
    if (style) {
    ...
    if (style == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the style field but value not provided",
        });
    }
    if (installments) {
      if (
        !validator.isValid(installments) ||
        !validator.isValidDecimalNumber(installments)
      ) {
        return res
          .status(400)
    ...
    if (installments == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the installments field but value not provided",
        });
    }
    ...
    if (!validator.isValidImage(files[0].originalname.toLowerCase())) {
      return res
        .status(400)
        .send({ status: false, message: "Image format is not correct" });
    }
    if (files && files.length > 0 && files.length < 2) {
      ...
      return res
        ...
        .send({
          status: false,
          message: "please provide only one product Image",
        });
    }
    ...
    return res
      ...
      .send({
        status: true,
        message: "product data create sucessfully",
        data: createProduct,
      });
  } catch (err) {
    ...
    if (Object.keys(productDetail).includes("size")) {
      if (!validator.isValid(productDetail.size)) {
        res
          ...
          .send({
            status: false,
            message: "you selected the size field but value not provided",
          });
        return;
      }
    }
    if (Object.keys(productDetail).includes("name")) {
      if (!validator.isValid(productDetail.name)) {
        res
          ...
          .send({
            status: false,
            message: "you selected the name field but value not provided",
          });
        return;
      }
    }
      ...
      if (!validator.isValid(productDetail.priceLessThan)) {
        res
          ...
          .send({
            status: false,
            message:
              "you selected the priceLessThan field but value not provided",
          });
        return;
      }
    }
      ...
      if (!validator.isValid(productDetail.priceGreaterThan)) {
        res
          ...
          .send({
            status: false,
            message:
              "you selected the priceGreaterThan field but value not provided",
          });
        return;
      }
    }
  ...
  try {
    ...
    if (Object.keys(req.body).length == 0) {
      return res
        ...
        .send({
          status: false,
          message: "Please Provide atleast one data to update product",
        });
    }
    let {
      title,
    ...
    if (title == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the title field but value not provided",
        });
    }
    ...
    if (description == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the description field but value not provided",
        });
    }
    ...
    if (price == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the price field but value not provided",
        });
    }
    ...
    if (currencyId) {
      if (!validator.isValid(currencyId) || currencyId.toUpperCase() != "INR") {
        return res
          ...
          .send({
            status: false,
            message: "please enter valid currencyId, e.g: INR",
          });
      }
    ...
    if (currencyId == "") {
      return res
        ...
        .send({
          status: false,
          message: "you selected the currencyId field but value not provided",
        });
    }
    //currencyFormat
    if (currencyFormat) {
      if (!validator.isValid(currencyFormat) || currencyFormat != "₹") {
        return res
          ...
          .send({
            status: false,
            message: "please enter valid currencyFormat, e.g: ₹",
          });
      }
    ...
    if (currencyFormat == "") {
      return res
        ...
        .send({
          status: false,
          message:
            "you selected the currencyFormat field but value not provided",
        });
    }
    //availableSizes
    if (availableSizes) {
      if (
        ...
        return res
          ...
          .send({
            status: false,
            message:
              "please enter valid availableSizes, at least one Size, e.g: M",
          });
      }
      availableSizes = availableSizes
        .trim()
    ...
    if (availableSizes == "") {
      return res
        ...
        .send({
          status: false,
          message:
            "you selected the availableSizes field but value not provided",
        });
    }
    //isFreeShipping
    if (isFreeShipping) {
    ...
    return res
      ...
      .send({
        status: true,
        message: "product data updated sucessfully",
        data: updatedProduct,
      });
  } catch (err) {
    res.status(500).send({ status: false, message: err.message });
...
const deleteProductbyId = async function (req, res) {
  try {
    ...
    return res
      .status(200)
      .send({ status: true, message: "product is deleted sucessfully" });
  } catch (error) {
